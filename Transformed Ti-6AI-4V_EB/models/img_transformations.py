...
class STFTEmbedder(TsImgEmbedder):
    ...
    def img_to_ts(self, x_image):
        ...
        min_real, max_real, min_imag, max_imag = (self.min_real.to(self.device), self.max_real.to(self.device), self.min_imag.to(self.device), self.max_imag.to(self.device))
        ...
        return torch.permute(x_time_series, (0, 2, 1))